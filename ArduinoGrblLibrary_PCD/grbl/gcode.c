...
uint8_t gc_execute_line(char *line)
{
  ...
  while (line[char_counter] != 0) { // Loop until no more g-code words in line.
    ...
    switch(letter) {
      ...
      gc_block.values.ijk[X_AXIS] = 0;
      gc_block.values.ijk[Y_AXIS] = 0;
      gc_block.values.ijk[Z_AXIS] = 0;
      ...
      default:
        ...
        switch(letter){
          ...
          case 'I': word_bit = WORD_I; gc_block.values.ijk[X_AXIS] += value; gc_block.values.ijk[Y_AXIS] -= value; ijk_words |= (1<<X_AXIS); break;
          case 'J': word_bit = WORD_J; gc_block.values.ijk[X_AXIS] += value; gc_block.values.ijk[Y_AXIS] += value; ijk_words |= (1<<Y_AXIS); break;
          ...
          case 'T': word_bit = WORD_T;
            ...
            gc_block.values.t = int_value;
						break;
          case 'X': word_bit = WORD_X; gc_block.values.xyz[X_AXIS] += value; gc_block.values.xyz[Y_AXIS] -= value; axis_words |= (1<<X_AXIS); break;
          case 'Y': word_bit = WORD_Y; gc_block.values.xyz[X_AXIS] += value; gc_block.values.xyz[Y_AXIS] += value; axis_words |= (1<<Y_AXIS); break;
